...
public class MotivoNoVistaDB {
    private static final String metodoWeb = "BBWS08ObtenerMotivoNoVisita"; // BBWS7ObtenerMeta?PIN=&IMEI=&IMSI=&IDAPP=&FFVV=FS&CodigoPais=21&NombreUsuario=1215&GMT=&Rol=
    private static String URL, DATA;
    public static PersistentObject persist;
    private static final long IDSTORE = 0x320ba437d1a86f9aL; // com.belcorp.entidades.MotivoNoVisita
    private static Vector objetos;
    private Usuario usuario;

    /**
     * Constructor del DAO para las Motivos de no visita
     */
    public MotivoNoVistaDB() {
     ...
     * @param node
     * @return si se puede formatear la información del XML a los objetos respectivos del motivos de no visita
     * @throws Exception
     */
